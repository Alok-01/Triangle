...
namespace CS.API.CompanyEmployees.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        [HttpPatch("{id}")]
        public IActionResult PartiallyUpdateEmployeeForCompany(Guid companyId, Guid id, [FromBody] JsonPatchDocument<EmployeeForUpdateDto> patchEmployee)
        {
            ...
            patchEmployee.ApplyTo(employeeToPatch);
